...
namespace MasterSweets.Controllers
{
    public class AdminProductsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "product_id,product_name,product_price,product_discount,product_des,product_des2,product_image1,product_image2,product_image3,product_image4,product_image5,product_quantity,category_id")] product product ,  HttpPostedFileBase img)
        {
        ...
        //        existingProduct.product_des = Request["product_des"];
        //        existingProduct.product_des2 = Request["product_des2"];
